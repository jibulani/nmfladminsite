var TableDatatablesEditable = function() {
    var e = function() {
        ...
        function t(e, t) {
            var n = e.fnGetData(t),
                a = $(">td", t);
            a[0].innerHTML = '<input type="text" class="form-control input-small" value="' + n[0] + '">', a[1].innerHTML = '<input type="text" class="form-control input-small" value="' + n[1] + '">', a[2].innerHTML = '<input type="text" class="form-control input-small" value="' + n[2] + '">', a[3].innerHTML = '<input type="text" class="form-control input-small" value="' + n[3] + '">', a[4].innerHTML = '<input type="text" class="form-control input-small" value="' + n[4] + '">', a[5].innerHTML = '<input type="text" class="form-control input-small" value="' + n[5] + '">', a[6].innerHTML = '<input type="text" class="form-control input-small" value="' + n[6] + '">', a[7].innerHTML = '<input type="text" class="form-control input-small" value="' + n[7] + '">', a[8].innerHTML = '<input type="text" class="form-control input-small" value="' + n[8] + '">', a[9].innerHTML = '<input type="text" class="form-control input-small" value="' + n[9] + '">', a[10].innerHTML = '<input type="text" class="form-control input-small" value="' + n[10] + '">', a[11].innerHTML = '<input type="text" class="form-control input-small" value="' + n[11] + '">', a[12].innerHTML = '<input type="text" class="form-control input-small" value="' + n[12] + '">', a[13].innerHTML = '<input type="text" class="form-control input-small" value="' + n[13] + '">', a[14].innerHTML = '<input type="text" class="form-control input-small" value="' + n[14] + '">', a[15].innerHTML = '<input type="text" class="form-control input-small" value="' + n[15] + '">', a[16].innerHTML = '<input type="text" class="form-control input-small" value="' + n[16] + '">', a[17].innerHTML = '<a class="edit" href="">Сохранить</a>', a[18].innerHTML = '<a class="cancel" href="">Отменить</a>'
        }
